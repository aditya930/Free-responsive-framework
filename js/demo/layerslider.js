...
var startX,
	...
	speed = '0.5s', //speed animation
	carusel = false,
	autoplay = false, // true if carusel = true
	time = 4000, // scrolling time
	path,
	src = 'images/',
	format = '.jpg',
	...
	for(var i = 0; i < slide_length; i++){
		slides_item[i].style.background = "url('" + src + path + slides_item[i].id + format + "') no-repeat scroll center top rgba(0, 0, 0, 0)";
	}
